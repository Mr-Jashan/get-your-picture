...
known_image_path = r'dataset/17.jpg'  # Replace with your known user image
...
target_image_path = r'dataset/17.jpg'  # Replace with the target image path
...
for face in target_faces:
    ...
    if similarity > 0.5:  # 1 means identical, so 0.6 or above is considered a match
        face_found = True
